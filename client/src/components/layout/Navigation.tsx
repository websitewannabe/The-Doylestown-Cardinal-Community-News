  ...
  const navLinks = [
    { name: "Home", path: "/" },
    {
      ...
      dropdownItems: [
        ...
        { name: "News", path: "/articles?category=News" },
        { name: "Events", path: "/articles?category=Events" },
        { name: "Community Spotlights", path: "/articles?category=Community Spotlights" },
        { name: "Student Spotlights", path: "/articles?category=Student Spotlights" },
        { name: "Fit", path: "/articles?category=Fit" },
        { name: "Taste", path: "/articles?category=Taste" },
        { name: "Play", path: "/articles?category=Play" },
        { name: "Live", path: "/articles?category=Live" },
      ],
    },
    {
      name: "Support Us",
