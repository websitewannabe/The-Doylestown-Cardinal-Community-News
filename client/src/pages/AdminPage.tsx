      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md p-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            You are now logged in. From here you can manage your site content.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition">
            ...
            <a href="/admin/articles" className="text-cardinal-red hover:underline">
              Manage Articles →
            </a>
          </div>
          ...
          <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition">
            ...
            <a href="/admin/categories" className="text-cardinal-red hover:underline">
              Manage Categories →
            </a>
          </div>
        </div>
