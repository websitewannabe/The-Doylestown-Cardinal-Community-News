      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-8">
          ...
          <div className="flex flex-col h-full">
            <div className="pt-20 px-8 flex-grow">
              ...
              <div className="mt-6 prose max-w-none">
                <p className="line-clamp-4 text-charcoal-gray/80">
                  {writer.bio}
                </p>
              </div>
            </div>
            <div className="px-8 pb-8 mt-6 border-t border-charcoal-gray/10 pt-6">
              <Link
                to={`/articles?author=${encodeURIComponent(writer.name)}`}
                className="inline-flex w-full items-center justify-center px-6 py-3 bg-cardinal-red text-white rounded-lg hover:bg-forest-green transition-colors group"
              >
                Popular Articles
