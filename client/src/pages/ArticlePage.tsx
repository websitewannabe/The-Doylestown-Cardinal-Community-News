...
const article = {
  ...
  content: `
    <h2 className="font-playfair text-2xl font-bold text-charcoal-gray mt-8 mb-4">Persuasive emotions that harm</h2>
  ...
  <h2 className="font-playfair text-2xl font-bold text-charcoal-gray mt-8 mb-4">A Way Out</h2>
