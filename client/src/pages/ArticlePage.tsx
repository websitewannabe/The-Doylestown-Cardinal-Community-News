...
const article = {
  ...
  content: `
    <h2 className="text-6xl md:text-7xl font-extrabold text-gray-900 mb-6">Persuasive emotions that harm</h2>
  ...
  <h2 className="text-6xl md:text-7xl font-extrabold text-gray-900 mb-6">A Way Out</h2>
