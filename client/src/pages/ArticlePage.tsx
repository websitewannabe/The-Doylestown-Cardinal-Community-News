...
const article = {
  ...
  content: `
    <h1 className="font-playfair text-2xl font-bold text-charcoal-gray mt-8 mb-4">Persuasive emotions that harm</h1>
  ...
  <h1 className="font-playfair text-2xl font-bold text-charcoal-gray mt-8 mb-4">A Way Out</h1>
